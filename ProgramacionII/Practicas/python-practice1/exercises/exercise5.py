...
# COMPLETAR - INICIO
strings_concatenados=f"¡Mamá estoy concatenando strings!"
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
strings_concatenados=f"{variable_01}{str(variable_02)}{variable_03}{str(variable_02)}{variable_04} Se llama {variable_05}"
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
strings_concatenados=f"{variable_01}{str(variable_02)}{variable_03}{variable_04}"
# COMPLETAR - FIN
